...
assert.deepEqual([...outputs[0].exports].sort(), ['BLACKLIST_LIMITS', 'FILTER_LIMITS', 'NativeCatalogTransport', 'NativeFilterMatcher', 'autoWatchBoards', 'catalogApiUrl', 'collectAutoWatches', 'planAutoWatches', 'readBlacklist', 'readNativeFilters', 'runNativeFilterJob', 'writeBlacklist'].sort());
