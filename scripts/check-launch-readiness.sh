...
- Local authenticated dispatch, isolated execution, operator recovery and lease-fenced publication are tested; deployed identities/certificate operations, production host/storage qualification and separate HTTP media serving remain unverified.
