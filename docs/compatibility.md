...
| B-007 | Staff moderation/authentication; project requirement | Separate WebAuthn app, expiring sessions, recent-authentication/CSRF checks, audited close/sticky/removal actions and operator-controlled enrollment/revocation/recovery | Staff database/HTTP tests and virtual-authenticator browser flow; hardware authenticator, production policies and independent review remain unverified |
