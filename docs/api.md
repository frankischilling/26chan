...
thread JSON advertises an eligible `tail_size`; a tail carries whole-thread
counts, the last omitted reply ID and the latest replies. See the
[tail contract](native-updater-tail.md) for board policy, conditional requests
