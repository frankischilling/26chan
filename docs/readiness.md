...
| Rewrite publication | Authorized target: [frankischilling/26chan](https://github.com/frankischilling/26chan); foundation, media/staff and API merged in PRs #2/#7/#9; staff inactivity tracked in [issue #11](https://github.com/frankischilling/26chan/issues/11) | Review the staff inactivity branch and hosted checks before merging |
