...
export function mountNativeKeybinds({ board, settings, watch, filter, update, auto, quickReply }) {
  ...
  const actions = { watch, filter, update, auto, quickReply, previous: () => page('prev'), next: () => page('next'),
